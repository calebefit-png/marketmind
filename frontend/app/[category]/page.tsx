...
import { AssetTable, MetricCard, MiniRanking, PageHeader, SourceBadge, VerifiedAssetTable } from "@/components/portal-ui";
...
export default async function CategoryPage({ params }: { params: Promise<{ category: string }> }) {
  ...
  const verifiedClasses: Record<string, string[]> = { acoes: ["stock"], fiis: ["fii"], etfs: ["etf", "fund_or_etf"], bdrs: ["bdr"] };
