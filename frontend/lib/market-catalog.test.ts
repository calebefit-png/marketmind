...
describe("mergeWithVerifiedMarketAssets", () => {
  it("retorna apenas o fechamento oficial e descarta ativos sem fonte verificada", () => {
    const merged = mergeWithVerifiedMarketAssets(
      [
        { ticker: "PETR4", name: "Petrobras PN", assetClass: "acoes", sector: "Legado", price: 10, change: 1, source: "unavailable", updatedAt: "Sem fonte" },
        { ticker: "AAPL", name: "Apple", assetClass: "stocks", sector: "Tecnologia", price: 20, change: 2, source: "unavailable", updatedAt: "Sem fonte" },
      ],
    ...
    expect(merged.find((asset) => asset.ticker === "AAPL")).toBeUndefined();
  });
