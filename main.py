...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.exception(
            "Falha ao conectar/inicializar o banco de dados. "
            "A API continuará no ar, mas rotas que dependem do banco falharão "
            "até DATABASE_URL estar configurado corretamente."
        )
